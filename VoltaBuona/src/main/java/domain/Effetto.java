...
public class Effetto {
     ...
     * applicare.
     *
     * Significato dei tipi: - DISARMA: imposta stato DISARMATO--> se l'arma è
     * equipaggiata la toglie. - FURIA: imposta stato FURIA; può applicare danno
     * maggiore o buff temporanei. - STORDIMENTO: imposta stato STORDITO;
     * penalizza azioni/attacchi; durata predefinita 2 turni. - AVVELENAMENTO:
     * imposta stato AVVELENATO; infligge danno periodico (es. 3 HP/turno);
     * durata predefinita 3 turni. - FURTO: imposta stato FURTO, si tolgono
     * delle monete dal portafoglio. - SALTA_TURNO: causa turni da saltare
     * (gestiti tramite `turniDaSaltare`). - NESSUN_EFFETTO: nessuna
     * conseguenza.
     */
